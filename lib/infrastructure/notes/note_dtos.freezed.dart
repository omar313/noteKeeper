...
class _$_NoteDto extends _NoteDto {
  ...
  @override
  String toString() {
    return 'NoteDto(id: $id, body: $body, color: $color, serverTimeStamp: $serverTimeStamp, todos: $todos)';
  }
...
abstract class _NoteDto extends NoteDto {
  const factory _NoteDto(
      ...
      required final dynamic serverTimeStamp,
      required final List<TodoItemDto> todos}) = _$_NoteDto;
